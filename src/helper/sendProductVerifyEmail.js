...
const sendProductVerifyEmail = async (toEmail, productName, storeName, storeUniqueId) => {
  try {
    ...
    const mailOptions = {
      ...
      to: toEmail,
      subject: "Your Product Verification Status ✅",
      html: `
        <div style="font-family: Arial; max-width:600px; margin:auto; padding:20px; border:1px solid #ddd; border-radius:10px; background:#f9f9f9;">
          ...
          <p>Your product has been <strong style="color:green;">verified</strong> by the admin.</p>

          <table style="width:100%; border-collapse: collapse; margin-top:20px;">
            <tr>
              <td style="padding:10px; border:1px solid #ddd;"><strong>Product Name</strong></td>
          ...
          <p style="margin-top:20px;">
            Your product is now live and visible to users 🚀
          </p>
    ...
    console.log("Product verification email sent ✅");

  } catch (error) {
    console.error("Product verify email failed:", error);
  }
};

module.exports = sendProductVerifyEmail;